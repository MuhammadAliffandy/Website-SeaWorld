<?php
    ...
    $dbbarang1 = $dbakun->showbarang('Induk Ikan Gabus');
    $dbbarang2 = $dbakun->showbarang('Induk Ikan Mujair');
    $dbbarang3 = $dbakun->showbarang('Induk Ikan Wader');
    $dbbarang4 = $dbakun->showbarang('Induk Ikan Sidat');
    $dbbarang5 = $dbakun->showbarang('Induk Ikan nilem');
    $dbbarang6 = $dbakun->showbarang('Bibit Ikan Patin');
    $dbbarang7 = $dbakun->showbarang('Bibit Ikan Bawal');
    $dbbarang8 = $dbakun->showbarang('HIU 2');
    $dbbarang9 = $dbakun->showbarang('All Feed-3');
    $dbbarang0 = $dbakun->showbarang('BIOVIT AQUATIC');
