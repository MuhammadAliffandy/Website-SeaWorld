<?php
    ...
    $dbbarang1 = $dbakun->showbarang('Kotak pendingin ikan');
    $dbbarang2 = $dbakun->showbarang('Terpal plastik');
    $dbbarang3 = $dbakun->showbarang('Bak atau kolam ikan');
    $dbbarang4 = $dbakun->showbarang('Pompa Kolam');
    $dbbarang5 = $dbakun->showbarang('Serokan benih');
    $dbbarang6 = $dbakun->showbarang('aerator');
    $dbbarang7 = $dbakun->showbarang('Penghangat kolam');
    $dbbarang8 = $dbakun->showbarang('Hapa telur');
    $dbbarang9 = $dbakun->showbarang('Bibit ikan lele');
    $dbbarang0 = $dbakun->showbarang('Bibit ikan Gurame');
